...
namespace OldParser {
    ...
    public class Parser {
        ...
        public static Int32 ParseNonEmptyList<TRet>(List<Token> src, Int32 begin, out List<TRet> list,
            FParse<TRet> Parse) {
        ...
        public static Int32 Parse2Choices<TRet, T1, T2>(List<Token> src, Int32 begin, out TRet node, FParse<T1> Parse1,
            FParse<T2> Parse2)
            where T1 : TRet
            where T2 : TRet
        ...
        public static Int32 ParseChoices<TRet>(List<Token> src, Int32 begin, out TRet node,
            List<FParse<TRet>> ParseFuncs) where TRet : class {
            return GetChoicesParser(ParseFuncs)(src, begin, out node);
        }

        public static Int32 ParseNonEmptyListWithSep<TRet>(List<Token> src, Int32 pos, out List<TRet> list,
            FParse<TRet> Parse, OperatorVal op) where TRet : class {
            list = new List<TRet>();
            TRet item;
        ...
        public static FParse<TAfter> GetModifiedParser<TAfter, TBefore>(FParse<TBefore> Parse,
            FModifier<TAfter, TBefore> ModifierFunc) where TAfter : class {
